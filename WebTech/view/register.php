...
<?php if (!isset($_SESSION['username'])){
    ...
    <div class="banner">
        ...
        <div class="icon-bar">
            ...
            <a class="active" href="register.php"><i class="fas fa-users"></i> REGISTRATION</a> 
            </div>
        <div class="container">
            <form method="post">
    ...
    <div class="banner">
        ...
        <div class="icon-bar">
            ...
            <a href="news.php"><i class="fa fa-globe"></i> NEWS</a>
            <a href="addStudent.php"><i class="fas fa-users"></i> ADD STUDENT</a>
            <a class="active" href="register.php"><i class="fas fa-users"></i> ADD OFFICER</a> 
            </div>
        <div class="container">
        <form method="post">
        <p>Please answer in correct value.</p>
